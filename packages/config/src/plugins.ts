...
/** The shared policy schema. Moniq combines this with each plugin's own
 * schema before validating; plugin authors do not need to reference it.
 */
export { PolicyType } from "./policy.js";
